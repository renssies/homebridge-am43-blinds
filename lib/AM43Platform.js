...
class AM43Platform {
    ...
    static CONFIG_KEY_INCLUDE_LIST = "include" // Not implemented yet
    static CONFIG_KEY_EXCLUDE_LIST = "exclude" // Not implemented yet
    ...
    configureDeviceOnAccessory(accessory, device) {
        ...
        if (pollInterval > 5) {
            ...
            this.log.warn("Polling for devices is disabled due too a low poll interval. This might cause a incorrect state in HomeKit apps. Polling requires a value of 5 (seconds) or higher.")
        }
    }
