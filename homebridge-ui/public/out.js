...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // homebridge-ui/src/index.js
  var import_react8 = __toModule(require_react());
  var import_react_dom = __toModule(require_react_dom());

  // homebridge-ui/src/components/app.jsx
  var import_react7 = __toModule(require_react());

  // homebridge-ui/src/components/deviceList.jsx
  var import_react2 = __toModule(require_react());

  // homebridge-ui/src/components/motorIcon.jsx
  var import_react = __toModule(require_react());
  var MotorIcon = ({small}) => /* @__PURE__ */ import_react.default.createElement("svg", {
  ...
  var motorIcon_default = MotorIcon;

  // homebridge-ui/src/components/deviceList.jsx
  var DeviceList = ({onSelect}) => {
    ...
    const scanForDevices = () => {
      ...
      homebridge.request("/scan_for_devices", {scan_time: 1e4}).then((scanResults) => {
    ...
    return /* @__PURE__ */ import_react2.default.createElement("div", {
      className: "card-body"
    }, /* @__PURE__ */ import_react2.default.createElement("ol", {
      className: "list-group"
    }, devices.map(({address, rssi, localName, id}) => /* @__PURE__ */ import_react2.default.createElement("button", {
      className: "list-group-item list-group-item-action d-flex flex-row",
      key: address,
      onClick: () => onSelect(id)
    }, /* @__PURE__ */ import_react2.default.createElement("div", {
      className: "mr-4"
    }, /* @__PURE__ */ import_react2.default.createElement(motorIcon_default, {
      small: true
    })), /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("h5", null, localName), /* @__PURE__ */ import_react2.default.createElement("p", null, address)), rssi && /* @__PURE__ */ import_react2.default.createElement("span", {
      className: "badge badge-primary badge-pill ml-auto "
    }, rssi, "dB")))), /* @__PURE__ */ import_react2.default.createElement("div", {
      className: "d-flex flex-column align-items-center"
    }, /* @__PURE__ */ import_react2.default.createElement("button", {
      type: "button",
      className: "btn btn-primary w-100",
      onClick: scanForDevices
    }, "Scan For Devices"), /* @__PURE__ */ import_react2.default.createElement("button", {
      type: "button",
  ...
  // homebridge-ui/src/components/motorInfo.jsx
  var import_react5 = __toModule(require_react());

  // homebridge-ui/src/hooks/useHomebridgeConfig.js
  var import_react3 = __toModule(require_react());
  var useHomebridgeConfig = () => {
    const [config, setConfig] = (0, import_react3.useState)(null);
    const [savedConfig, setSavedConfig] = (0, import_react3.useState)(null);
  ...
  // homebridge-ui/src/components/setLimit.jsx
  var import_react4 = __toModule(require_react());
  var SetLimit = ({deviceId, openOrClose, onClose}) => {
    const [canSet, setCanSet] = (0, import_react4.useState)(false);
    ...
    return /* @__PURE__ */ import_react4.default.createElement("div", {
      ...
      onMouseDown: openMotor,
      onMouseUp: stopMotor
    }, "Open"), /* @__PURE__ */ import_react4.default.createElement("button", {
      type: "button",
      disabled: !canSet,
      className: "btn btn-danger",
      onMouseDown: stopMotor
    }, "Stop"), /* @__PURE__ */ import_react4.default.createElement("button", {
      type: "button",
      disabled: !canSet,
      className: "btn btn-primary",
      onMouseDown: closeMotor,
      onMouseUp: stopMotor
    }, "Close")), /* @__PURE__ */ import_react4.default.createElement("button", {
      type: "button",
      disabled: !canSet,
      className: "btn btn-primary w-100",
      onClick: saveAdjustment
    }, "Save"), /* @__PURE__ */ import_react4.default.createElement("button", {
      type: "button",
      className: "btn btn-secondary w-100",
      onClick: onClose
    }, "Cancel"));
  };
  var setLimit_default = SetLimit;
  ...
  var MotorInfo = ({deviceId}) => {
    const [device, setDevice] = (0, import_react5.useState)(null);
    const [newName, setNewName] = (0, import_react5.useState)(null);
    const [passcode, setPasscode] = (0, import_react5.useState)("8888");
    const [hasAuthed, setHasAuthed] = (0, import_react5.useState)(false);
    const {config, updateConfig, saveConfig} = useHomebridgeConfig();
    const [limitUI, setLimitUI] = (0, import_react5.useState)(null);
    ...
    (0, import_react5.useEffect)(() => {
      homebridge.showSpinner();
      homebridge.request("/connect_to_device", {device_id: deviceId}).then((deviceResult) => {
        homebridge.hideSpinner();
        console.log(deviceResult);
        setNewName(deviceResult.localName);
        setDevice(deviceResult);
      });
      const setAuthTrue = () => setHasAuthed(true);
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", {
      ...
      className: "mr-3"
    }, /* @__PURE__ */ import_react5.default.createElement(motorIcon_default, null)), device && /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "w-100"
    }, /* @__PURE__ */ import_react5.default.createElement("div", {
    ...
    }), device.localName !== newName && newName?.length > 0 && /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "input-group-append"
    }, /* @__PURE__ */ import_react5.default.createElement("button", {
      type: "button",
      onClick: submitNewName,
      className: "btn-outline-secondary"
    }, "Update"))), /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "input-group mb-3"
    }, /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "input-group-prepend"
    }, /* @__PURE__ */ import_react5.default.createElement("span", {
      className: "input-group-text",
      id: "motor-address"
    }, "Address")), /* @__PURE__ */ import_react5.default.createElement("input", {
    ...
    })), !hasAuthed && /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "input-group mb-3"
    }, /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "input-group-prepend"
    }, /* @__PURE__ */ import_react5.default.createElement("span", {
      className: "input-group-text",
      id: "passcode-label"
    }, "Passcode")), /* @__PURE__ */ import_react5.default.createElement("input", {
      value: passcode,
      pattern: "[0-9]{4}",
      ...
      className: "btn-outline-secondary"
    }, "Auth"))), hasAuthed && /* @__PURE__ */ import_react5.default.createElement(import_react5.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "card border-light mb-3"
    }, /* @__PURE__ */ import_react5.default.createElement("button", {
      type: "button",
      onClick: () => setLimitUI((l) => l === null ? LIMIT_MODES.OPENED : null),
      className: "card-header btn btn-outline-secondary btn-sm m-0"
    }, "Set Open Limit"), limitUI === LIMIT_MODES.OPENED && /* @__PURE__ */ import_react5.default.createElement(setLimit_default, {
      openOrClose: limitUI,
      deviceId,
      ...
      type: "button",
      onClick: () => setLimitUI((l) => l === null ? LIMIT_MODES.CLOSED : null),
      className: "card-header btn btn-outline-secondary btn-sm m-0"
    }, "Set Close Limit"), limitUI === LIMIT_MODES.CLOSED && /* @__PURE__ */ import_react5.default.createElement(setLimit_default, {
      openOrClose: limitUI,
      deviceId,
      onClose: () => setLimitUI(null)
    }))), config && /* @__PURE__ */ import_react5.default.createElement("button", {
      type: "button",
      className: `btn ${isInAllowedDevices ? "btn-danger" : "btn-secondary"}`,
      onClick: isInAllowedDevices ? removeFromAllowedDevices : addToAllowedDevices
    }, isInAllowedDevices ? "Remove from" : "Add to", " Allowed List (on save)")), !device && /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("div", {
      className: "alert alert-secondary",
      role: "alert"
    }, "Attempting to connect to motor...")));
  };
  var motorInfo_default = MotorInfo;

  // homebridge-ui/src/components/breadCrumbs.jsx
  var import_react6 = __toModule(require_react());
  var BreadCrumbs = ({onExitBlindsEngineMode, onReturnToDeviceList, selectedDeviceId}) => /* @__PURE__ */ import_react6.default.createElement("nav", {
    "aria-label": "breadcrumb"
  }, /* @__PURE__ */ import_react6.default.createElement("ol", {
    className: "breadcrumb"
  }, /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "breadcrumb-item"
  }, /* @__PURE__ */ import_react6.default.createElement("a", {
    href: "#",
    onClick: onExitBlindsEngineMode
  }, "Settings")), /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "breadcrumb-item"
  }, "Blind Engine"), selectedDeviceId !== null ? /* @__PURE__ */ import_react6.default.createElement(import_react6.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "breadcrumb-item"
  }, /* @__PURE__ */ import_react6.default.createElement("a", {
    href: "#",
    onClick: onReturnToDeviceList
  }, "Device List")), /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "breadcrumb-item active",
    "aria-current": "page"
  }, "Motor")) : /* @__PURE__ */ import_react6.default.createElement(import_react6.Fragment, null, /* @__PURE__ */ import_react6.default.createElement("li", {
    className: "breadcrumb-item active",
    "aria-current": "page"
  }, "Device List"))));
  ...
  // homebridge-ui/src/components/app.jsx
  var App = () => {
    const [inBlindEngineMode, setInBlindEngineMode] = (0, import_react7.useState)(false);
    ...
    const [selectedDeviceId, setSelectedDeviceId] = (0, import_react7.useState)(null);
    const onExit = () => {
    ...
    if (inBlindEngineMode) {
      return /* @__PURE__ */ import_react7.default.createElement("div", {
        className: "card"
      }, /* @__PURE__ */ import_react7.default.createElement(breadCrumbs_default, {
        selectedDeviceId,
        onExitBlindsEngineMode: onExit,
        onReturnToDeviceList: () => setSelectedDeviceId(null)
      }), selectedDeviceId !== null ? /* @__PURE__ */ import_react7.default.createElement(motorInfo_default, {
        deviceId: selectedDeviceId
      }) : /* @__PURE__ */ import_react7.default.createElement(deviceList_default, {
        onSelect: (id) => {
          console.log({id});
  ...
  (async () => {
    ...
    homebridge.addEventListener("limit-set-success", () => {
      homebridge.toast.warning("Motor can overun until this mode's exited", "Limit Adjustment Mode Entered");
    });
    ...
    import_react_dom.default.render(import_react8.default.createElement(app_default), document.querySelector(".am43-app-container"));
  })();
})();
